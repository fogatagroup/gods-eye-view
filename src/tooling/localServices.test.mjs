...
import { overpassProxy } from 'quantifeye-world/server/providers/overpass';
import { militaryInstallationsProxy } from 'quantifeye-world/server/providers/military-installations';
import {
  regionalBriefProxy,
  weatherEffectsProxy,
} from 'quantifeye-world/server/providers/regional';
import { openAiRealtimeProxy } from 'quantifeye-world/server/providers/openai';
import { keySetupEndpoint } from 'quantifeye-world/server/standalone/key-setup';
