    ...
    parameters: {
      ...
      properties: {
        layerId: {
          type: 'string',
          description:
            'Common-name mapping for the non-obvious ids: space mission(s) → rocket-launches; fires/wildfires/active fires → local-firms (NASA FIRMS); ships/vessels/boats → ais-live-vessels; Panamá Oficial hotels → panama-official-hotels; Panamá Oficial agencies/operators → panama-official-agencies; Panamá Oficial tourism/attractions → panama-official-tourism; coastal flood/inundación costera → coastal-flood-2050; administrative divisions/political boundaries/divisiones administrativas → administrative-divisions; undersea/submarine cables → telegeography-submarine-cables; datacenters → local-datacenters; dams → local-dams; bikes/bike share → bikeshare; street traffic/congestion → traffic; traffic cameras → cctv; internet radio/stations → radio; ALPR/license plate readers/Flock cameras → alpr-cameras.',
          enum: [
            'flights',
            'military',
            'earthquakes',
